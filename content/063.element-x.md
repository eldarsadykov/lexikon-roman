...
[Häuschen](haeuschen){.arrow-link}.

---

 ## Element X 2. 

[Häuschen](haeuschen){.arrow-link}. Veraltete Pädagogen schrecken es: Sei brav, sonst kommen die Schwarzdecker.
...
[Stadtbibliothek](stadtbibliothek){.arrow-link}.
...
Torbogen-Haus mit Durchblick zu ferner [Landkonditorei](landkonditorei){.arrow-link}.

---

 ## Element X 15. 

Torbogen-Haus mit Durchblick zu fernem [Eissalon](eissalon){.arrow-link}.
